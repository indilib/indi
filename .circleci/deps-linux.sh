...
CURDIR="$(pwd)"
apt-get -q -y install libusb-1.0-0-dev libconfuse-dev python3-all-dev doxygen libboost-test-dev python-all-dev swig g++
cd ~
mkdir ftdi_src
cd ftdi_src
...
cd ..
dpkg -i libftdi1-2_1.2-5build1_amd64.deb
