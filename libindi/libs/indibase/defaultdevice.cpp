...
void DefaultDevice::Spectrum(void *buf, void *out, int len, int size, int bits_per_sample) {
...
void DefaultDevice::Histogram(void *buf, void *out, int buf_len, int histogram_size, int bits_per_sample) {
...
void DefaultDevice::FourierTransform(void *buf, void *out, int dims, int *sizes, int bits_per_sample) {
    //Create the dsp stream
    dsp_stream_p stream = dsp_stream_new();
...
void DefaultDevice::Convolution(void *buf, void *matrix, void *out, int dims, int *sizes, int matrix_dims, int *matrix_sizes, int bits_per_sample) {
    //Create the dsp stream
    dsp_stream_p stream = dsp_stream_new();
    for(int dim = 0; dim < dims; dim++)
        dsp_stream_add_dim(stream, sizes[dim]);
