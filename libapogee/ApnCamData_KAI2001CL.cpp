/////////////////////////////////////////////////////////////
//
// ApnCamData_KAI2001CL.cpp:  Implementation file for the CApnCamData_KAI2001CL class.
//
...
CApnCamData_KAI2001CL::CApnCamData_KAI2001CL()
{
}
...
void CApnCamData_KAI2001CL::Initialize()
{
	strcpy( m_Sensor, "KAI2001CL" );
	strcpy( m_CameraModel, "2001cl" );
	m_CameraId = 71;
	m_InterlineCCD = true;
...
void CApnCamData_KAI2001CL::set_vpattern()
{
...
void CApnCamData_KAI2001CL::set_hpattern_skip_sixteen()
{
...
void CApnCamData_KAI2001CL::set_hpattern_clamp_sixteen()
{
	const unsigned short Mask = 0x0;
	const unsigned short BinningLimit = 1;
	const unsigned short RefNumElements = 11;
...
void CApnCamData_KAI2001CL::set_hpattern_roi_sixteen()
{
	const unsigned short Mask = 0x0;
...
void CApnCamData_KAI2001CL::set_hpattern_skip_twelve()
{
	const unsigned short Mask = 0x0;
	const unsigned short BinningLimit = 1;
...
void CApnCamData_KAI2001CL::set_hpattern_clamp_twelve()
{
	const unsigned short Mask = 0x0;
	const unsigned short BinningLimit = 1;
	const unsigned short RefNumElements = 0;
...
void CApnCamData_KAI2001CL::set_hpattern_roi_twelve()
{
...
void CApnCamData_KAI2001CL::set_hpattern(	APN_HPATTERN_FILE	*Pattern,
											unsigned short	Mask,
