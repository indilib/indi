/////////////////////////////////////////////////////////////
//
// ApnCamData_KAF09000.cpp:  Implementation file for the CApnCamData_KAF09000 class.
//
...
CApnCamData_KAF09000::CApnCamData_KAF09000()
{
}
...
void CApnCamData_KAF09000::Initialize()
{
	strcpy( m_Sensor, "KAF09000" );
	strcpy( m_CameraModel, "9000" );
	m_CameraId = 4;
...
void CApnCamData_KAF09000::set_vpattern()
{
	const unsigned short Mask = 0x0;
	const unsigned short NumElements = 116;
	unsigned short Pattern[NumElements] = 
	{
		0x0000, 0x0000, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 
		0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 
		0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 
		0x0002, 0x0202, 0x0202, 0x0202, 0x0202, 0x0202, 0x0202, 0x0202, 0x0202, 0x0202, 
		0x0202, 0x0002, 0x0002, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 
		0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 
		0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 
		0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 
		0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0000, 0x0000, 0x0000, 0x0000, 
...
void CApnCamData_KAF09000::set_hpattern_skip_sixteen()
{
	...
	{
		0x0068, 0x006A, 0x006A, 0x0068, 0x1068, 0x1068, 0x1068, 0x0068, 0x0068, 0x0068, 
		0x0068
	};

	unsigned short SigPatternData[SigNumElements] = 
	{
		0x0064, 0x0064, 0x0064, 0x0064, 0x0064, 0x0064, 0x0064, 0x0064, 0x0064, 0x0064, 
		0x0065, 0x0064
	};
...
void CApnCamData_KAF09000::set_hpattern_clamp_sixteen()
{
	const unsigned short Mask = 0x2;
	const unsigned short BinningLimit = 1;
	const unsigned short RefNumElements = 11;
...
void CApnCamData_KAF09000::set_hpattern_roi_sixteen()
{
	const unsigned short Mask = 0x2;
	...
	unsigned short RefPatternData[RefNumElements] = 
	{
		0x0068, 0x006A, 0x006A, 0x0068, 0x1068, 0x1068, 0x1068, 0x0068, 0x0068, 0x00E8, 
		0x00E8, 0x00C8, 0x00C8, 0x00C8, 0x00C8, 0x00C8, 0x00C8, 0x00C8, 0x00C8, 0x00C8, 
		0x00C8, 0x00C8, 0x00C8, 0x00C8, 0x00C8
	};

	unsigned short SigPatternData[SigNumElements] = 
	{
		0x0044, 0x0044, 0x0044, 0x0044, 0x0044, 0x0044, 0x0144, 0x0144, 0x0104, 0x0104, 
		0x0104, 0x0104, 0x0104, 0x0104, 0x0104, 0x0104, 0x0104, 0x0104, 0x0104, 0x0104, 
		0x0104, 0x0104, 0x0104, 0x0004, 0x8004, 0x8405, 0x0004
	};
...
void CApnCamData_KAF09000::set_hpattern_skip_twelve()
{
	const unsigned short Mask = 0x0;
	const unsigned short BinningLimit = 1;
	...
	unsigned short BinPatternData[1][256] = {
	{
		0x0008, 0x020A, 0x0008, 0x0008, 0x0008, 0x2008, 0x0004, 0x0004, 0x0004, 0x0005, 
		0x4004
	} };
...
void CApnCamData_KAF09000::set_hpattern_clamp_twelve()
{
	const unsigned short Mask = 0x0;
	const unsigned short BinningLimit = 1;
	const unsigned short RefNumElements = 0;
	...
	unsigned short BinPatternData[1][256] = {
	{
		0x0808, 0x0A0A, 0x0808, 0x0808, 0x0808, 0x0808, 0x0804, 0x2804, 0x0804, 0x0804, 
		0x0805, 0x4804
	} };
...
void CApnCamData_KAF09000::set_hpattern_roi_twelve()
{
	...
	unsigned short BinNumElements[APN_MAX_HBINNING] = 
	{
		0x000D, 0x0011, 0x0019, 0x0021, 0x0029, 0x0031, 0x0039, 0x0041, 0x0049, 0x0051
	};

	unsigned short BinPatternData[10][256] = {
	{
		0x0008, 0x020A, 0x0008, 0x0008, 0x0008, 0x0008, 0x0004, 0x2004, 0x0004, 0x0004, 
		0x0004, 0x8005, 0xC004
	},
	{
		0x4008, 0x000A, 0x0008, 0x0008, 0x0208, 0x0004, 0x2004, 0x0004, 0x0004, 0x0008, 
		0x0008, 0x0008, 0x0008, 0x0004, 0x0004, 0x8005, 0x8004
	},
	{
		0x4008, 0x000A, 0x0008, 0x0008, 0x0208, 0x0004, 0x2004, 0x0004, 0x0004, 0x0008, 
		0x0008, 0x0008, 0x0008, 0x0004, 0x0004, 0x0004, 0x0004, 0x0008, 0x0008, 0x0008, 
		0x0008, 0x0004, 0x0004, 0x8005, 0x8004
	},
	{
		0x4008, 0x000A, 0x0008, 0x0008, 0x0208, 0x0004, 0x2004, 0x0004, 0x0004, 0x0008, 
		0x0008, 0x0008, 0x0008, 0x0004, 0x0004, 0x0004, 0x0004, 0x0008, 0x0008, 0x0008, 
	...
	},
	{
		...
		0x0004, 0x0008, 0x0008, 0x0008, 0x0008, 0x0004, 0x0004, 0x8005, 0x8004
	},
	{
		0x4008, 0x000A, 0x0008, 0x0008, 0x0208, 0x0004, 0x2004, 0x0004, 0x0004, 0x0008, 
		0x0008, 0x0008, 0x0008, 0x0004, 0x0004, 0x0004, 0x0004, 0x0008, 0x0008, 0x0008, 
...
void CApnCamData_KAF09000::set_hpattern(	APN_HPATTERN_FILE	*Pattern,
											unsigned short	Mask,
