/////////////////////////////////////////////////////////////
//
// ApnCamData_KAI11000ML.cpp:  Implementation file for the CApnCamData_KAI11000ML class.
//
...
CApnCamData_KAI11000ML::CApnCamData_KAI11000ML()
{
}
...
void CApnCamData_KAI11000ML::Initialize()
{
	strcpy( m_Sensor, "KAI11000ML" );
	strcpy( m_CameraModel, "11002ml" );
	m_CameraId = 67;
	m_InterlineCCD = true;
...
void CApnCamData_KAI11000ML::set_vpattern()
{
	const unsigned short Mask = 0x106;
	const unsigned short NumElements = 59;
	unsigned short Pattern[NumElements] = 
	{
		...
		0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0002, 0x0002, 0x0002, 
		0x0002, 0x0002, 0x0002, 0x0002, 0x0302, 0x0302, 0x0302, 0x0302, 0x0302, 0x0302, 
		0x0302, 0x0302, 0x0302, 0x0302, 0x0002, 0x0002, 0x0002, 0x0003, 0x0002
	};
...
void CApnCamData_KAI11000ML::set_hpattern_skip_sixteen()
{
	...
	{
		0x0068, 0x006A, 0x006A, 0x0068, 0x1068, 0x1068, 0x1068, 0x0068, 0x00E8, 0x00C8, 
		0x00C8
	};
...
void CApnCamData_KAI11000ML::set_hpattern_clamp_sixteen()
{
	const unsigned short Mask = 0xC;
	const unsigned short BinningLimit = 1;
	const unsigned short RefNumElements = 11;
...
void CApnCamData_KAI11000ML::set_hpattern_roi_sixteen()
{
	const unsigned short Mask = 0xC;
...
void CApnCamData_KAI11000ML::set_hpattern_skip_twelve()
{
	...
	unsigned short BinPatternData[1][256] = {
	{
		0x400A, 0x0008, 0x0208, 0x2005, 0x0004
	} };
...
void CApnCamData_KAI11000ML::set_hpattern_clamp_twelve()
{
	const unsigned short Mask = 0x0;
	const unsigned short BinningLimit = 1;
	const unsigned short RefNumElements = 0;
...
void CApnCamData_KAI11000ML::set_hpattern_roi_twelve()
{
	const unsigned short Mask = 0x680C;
	...
	{
		0x0008, 0x020A, 0x0208, 0x0208, 0x0208, 0x2004, 0x0004, 0x0004, 0x8005, 0xC004
	},
	{
...
void CApnCamData_KAI11000ML::set_hpattern(	APN_HPATTERN_FILE	*Pattern,
											unsigned short	Mask,
