/////////////////////////////////////////////////////////////
//
// ApnCamData_ASCENT2000.cpp:  Implementation file for the CApnCamData_ASCENT2000 class.
//
...
CApnCamData_ASCENT2000::CApnCamData_ASCENT2000()
{
}
...
void CApnCamData_ASCENT2000::Initialize()
{
	strcpy( m_Sensor, "ASCENT2000" );
	strcpy( m_CameraModel, "2000" );
	m_CameraId = 322;
	m_InterlineCCD = true;
...
void CApnCamData_ASCENT2000::set_vpattern()
{
...
void CApnCamData_ASCENT2000::set_hpattern_skip_sixteen()
{
...
void CApnCamData_ASCENT2000::set_hpattern_clamp_sixteen()
{
	const unsigned short Mask = 0x0;
	const unsigned short BinningLimit = 1;
	const unsigned short RefNumElements = 0;
...
void CApnCamData_ASCENT2000::set_hpattern_roi_sixteen()
{
	const unsigned short Mask = 0x0;
	const unsigned short BinningLimit = 1;
	const unsigned short RefNumElements = 0;
...
void CApnCamData_ASCENT2000::set_hpattern_skip_twelve()
{
	const unsigned short Mask = 0x0;
	const unsigned short BinningLimit = 1;
	const unsigned short RefNumElements = 0;
...
void CApnCamData_ASCENT2000::set_hpattern_clamp_twelve()
{
	const unsigned short Mask = 0x0;
	const unsigned short BinningLimit = 1;
	const unsigned short RefNumElements = 0;
...
void CApnCamData_ASCENT2000::set_hpattern_roi_twelve()
{
...
void CApnCamData_ASCENT2000::set_hpattern(	APN_HPATTERN_FILE	*Pattern,
											unsigned short	Mask,
