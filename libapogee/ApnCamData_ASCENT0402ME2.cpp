/////////////////////////////////////////////////////////////
//
// ApnCamData_ASCENT0402ME2.cpp:  Implementation file for the CApnCamData_ASCENT0402ME2 class.
//
...
CApnCamData_ASCENT0402ME2::CApnCamData_ASCENT0402ME2()
{
}
...
void CApnCamData_ASCENT0402ME2::Initialize()
{
	strcpy( m_Sensor, "ASCENT0402ME2" );
...
void CApnCamData_ASCENT0402ME2::set_vpattern()
{
...
void CApnCamData_ASCENT0402ME2::set_hpattern_skip_sixteen()
{
...
void CApnCamData_ASCENT0402ME2::set_hpattern_clamp_sixteen()
{
	const unsigned short Mask = 0x0;
	const unsigned short BinningLimit = 1;
	const unsigned short RefNumElements = 0;
...
void CApnCamData_ASCENT0402ME2::set_hpattern_roi_sixteen()
{
	const unsigned short Mask = 0x0;
	const unsigned short BinningLimit = 1;
	const unsigned short RefNumElements = 0;
...
void CApnCamData_ASCENT0402ME2::set_hpattern_skip_twelve()
{
	const unsigned short Mask = 0x0;
	const unsigned short BinningLimit = 1;
	const unsigned short RefNumElements = 0;
...
void CApnCamData_ASCENT0402ME2::set_hpattern_clamp_twelve()
{
	const unsigned short Mask = 0x0;
	const unsigned short BinningLimit = 1;
	const unsigned short RefNumElements = 0;
...
void CApnCamData_ASCENT0402ME2::set_hpattern_roi_twelve()
{
...
void CApnCamData_ASCENT0402ME2::set_hpattern(	APN_HPATTERN_FILE	*Pattern,
											unsigned short	Mask,
