...
{
    return (filter_bandwidth/wavelength)*incident_surface*pow(10, -0.4*rel_magnitude)/LUMEN(wavelength);
}

double calc_rel_magnitude(double photon_flux, double filter_bandwidth, double wavelength, double incident_surface)
{
    return (filter_bandwidth/wavelength)*incident_surface*log10(photon_flux*LUMEN(wavelength))/-0.4;
}
