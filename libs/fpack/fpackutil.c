...
static char tempfilename[SZ_STR];
static char tempfilename2[SZ_STR];
static char tempfilename3[SZ_STR];
...
static clock_t scpu, ecpu;
static long startsec;   /* start of elapsed time interval */
static int startmilli;  /* start of elapsed time interval */
...
static FILE *outreport;

/* dimension of central image area to be sampled for test statistics */
static int XSAMPLE = 4100;
static int YSAMPLE = 4100;
...
int fp_unpack (char *infits, char *outfits, fpstate fpvar)
{
        ...
        char *loc=NULL, *hduloc=NULL, hduname[SZ_STR]={0};
