/////////////////////////////////////////////////////////////
//
// ApnCamData_KAI2020MLB.cpp:  Implementation file for the CApnCamData_KAI2020MLB class.
//
...
CApnCamData_KAI2020MLB::CApnCamData_KAI2020MLB()
{
}
...
void CApnCamData_KAI2020MLB::Initialize()
{
	strcpy( m_Sensor, "KAI2020MLB" );
	strcpy( m_CameraModel, "2020ml" );
	m_CameraId = 72;
	m_InterlineCCD = true;
...
void CApnCamData_KAI2020MLB::set_vpattern()
{
	const unsigned short Mask = 0x16;
...
void CApnCamData_KAI2020MLB::set_hpattern_skip_sixteen()
{
...
void CApnCamData_KAI2020MLB::set_hpattern_clamp_sixteen()
{
	const unsigned short Mask = 0x2;
	const unsigned short BinningLimit = 1;
	const unsigned short RefNumElements = 11;
...
void CApnCamData_KAI2020MLB::set_hpattern_roi_sixteen()
{
	const unsigned short Mask = 0x2;
...
void CApnCamData_KAI2020MLB::set_hpattern_skip_twelve()
{
...
void CApnCamData_KAI2020MLB::set_hpattern_clamp_twelve()
{
	const unsigned short Mask = 0x0;
	const unsigned short BinningLimit = 1;
	const unsigned short RefNumElements = 0;
	...
	unsigned short BinPatternData[1][256] = {
	{
		0x0806, 0x080A, 0x0808, 0x0808, 0x2808, 0x0804, 0x0804, 0x0804, 0x4805, 0x0804
	} };
...
void CApnCamData_KAI2020MLB::set_hpattern_roi_twelve()
{
	...
	unsigned short BinNumElements[APN_MAX_HBINNING] = 
	{
		0x000A, 0x000F, 0x0015, 0x001B, 0x0021, 0x0027, 0x002D, 0x0033
	};

	unsigned short BinPatternData[8][256] = {
	{
		0x0004, 0x020A, 0x0208, 0x0208, 0x0208, 0x2004, 0x0004, 0x0004, 0x8005, 0xC004
	},
	{
		0x0004, 0x020A, 0x0208, 0x0208, 0x0208, 0x2004, 0x0004, 0x0004, 0x0008, 0x0008, 
		0x0008, 0x0004, 0x0004, 0x8005, 0xC004
	},
	{
		0x0004, 0x020A, 0x0208, 0x0208, 0x0208, 0x2004, 0x0004, 0x0004, 0x0008, 0x0008, 
		0x0008, 0x0004, 0x0004, 0x0004, 0x0008, 0x0008, 0x0008, 0x0004, 0x0004, 0x8005, 
		0xC004
	},
	{
		0x0004, 0x020A, 0x0208, 0x0208, 0x0208, 0x2004, 0x0004, 0x0004, 0x0008, 0x0008, 
		0x0008, 0x0004, 0x0004, 0x0004, 0x0008, 0x0008, 0x0008, 0x0004, 0x0004, 0x0004, 
		0x0008, 0x0008, 0x0008, 0x0004, 0x0004, 0x8005, 0xC004
	},
	{
		0x0004, 0x020A, 0x0208, 0x0208, 0x0208, 0x2004, 0x0004, 0x0004, 0x0008, 0x0008, 
		0x0008, 0x0004, 0x0004, 0x0004, 0x0008, 0x0008, 0x0008, 0x0004, 0x0004, 0x0004, 
		0x0008, 0x0008, 0x0008, 0x0004, 0x0004, 0x0004, 0x0008, 0x0008, 0x0008, 0x0004, 
	...
	},
	{
		...
		0x0008, 0x0004, 0x0004, 0x0004, 0x0008, 0x0008, 0x0008, 0x0004, 0x0004, 0x0004, 
		0x0008, 0x0008, 0x0008, 0x0004, 0x0004, 0x0004, 0x0008, 0x0008, 0x0008, 0x0004, 
		0x0004, 0x0004, 0x0008, 0x0008, 0x0008, 0x0004, 0x0004, 0x8005, 0xC004
	},
	{
		0x0004, 0x020A, 0x0208, 0x0208, 0x0208, 0x2004, 0x0004, 0x0004, 0x0008, 0x0008, 
		0x0008, 0x0004, 0x0004, 0x0004, 0x0008, 0x0008, 0x0008, 0x0004, 0x0004, 0x0004, 
		0x0008, 0x0008, 0x0008, 0x0004, 0x0004, 0x0004, 0x0008, 0x0008, 0x0008, 0x0004, 
		0x0004, 0x0004, 0x0008, 0x0008, 0x0008, 0x0004, 0x0004, 0x0004, 0x0008, 0x0008, 
		0x0008, 0x0004, 0x0004, 0x8005, 0xC004
	},
	{
		0x0004, 0x020A, 0x0208, 0x0208, 0x0208, 0x2004, 0x0004, 0x0004, 0x0008, 0x0008, 
...
void CApnCamData_KAI2020MLB::set_hpattern(	APN_HPATTERN_FILE	*Pattern,
											unsigned short	Mask,
