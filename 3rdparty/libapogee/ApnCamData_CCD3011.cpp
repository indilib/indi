/////////////////////////////////////////////////////////////
//
// ApnCamData_CCD3011.cpp:  Implementation file for the CApnCamData_CCD3011 class.
//
...
CApnCamData_CCD3011::CApnCamData_CCD3011()
{
}
...
void CApnCamData_CCD3011::Initialize()
{
	strcpy( m_Sensor, "CCD3011" );
...
void CApnCamData_CCD3011::set_vpattern()
{
	const unsigned short Mask = 0x0;
	const unsigned short NumElements = 253;
	unsigned short Pattern[NumElements] = 
	{
		...
		0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 
		0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 
		0x0008, 0x0008, 0x0008, 0x0008, 0x000A, 0x000A, 0x000A, 0x000A, 0x000A, 0x000A, 
		0x000A, 0x000A, 0x000A, 0x000A, 0x000A, 0x000A, 0x000A, 0x000A, 0x000A, 0x000A, 
		0x000A, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 
		0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 
		0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 
		0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0006, 0x0006, 0x0006, 0x0006, 
		0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 
		0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 
		0x0006, 0x0006, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 
		...
		0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 
		0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 
		0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 0x0008, 0x0008, 0x0008, 0x0008, 
		0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 
		0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 
...
void CApnCamData_CCD3011::set_hpattern_skip_sixteen()
{
	const unsigned short Mask = 0x0;
...
void CApnCamData_CCD3011::set_hpattern_clamp_sixteen()
{
	const unsigned short Mask = 0x0;
	const unsigned short BinningLimit = 1;
	const unsigned short RefNumElements = 22;
...
void CApnCamData_CCD3011::set_hpattern_roi_sixteen()
{
	const unsigned short Mask = 0x0;
	const unsigned short BinningLimit = 6;
	const unsigned short RefNumElements = 49;
	const unsigned short SigNumElements = 26;
	...
	unsigned short RefPatternData[RefNumElements] = 
	{
		...
		0x0074, 0x0074, 0x00F4, 0x00D4, 0x00D4, 0x00D4, 0x00D4, 0x00D4, 0x00D4, 0x00D4, 
	...
	unsigned short SigPatternData[SigNumElements] = 
	{
		...
		0x8104, 0x0004, 0x0004, 0x0004, 0x0405, 0x0404
	};
...
void CApnCamData_CCD3011::set_hpattern_skip_twelve()
{
	const unsigned short Mask = 0x0;
	const unsigned short BinningLimit = 1;
...
void CApnCamData_CCD3011::set_hpattern_clamp_twelve()
{
	const unsigned short Mask = 0x0;
...
void CApnCamData_CCD3011::set_hpattern_roi_twelve()
{
...
void CApnCamData_CCD3011::set_hpattern(	APN_HPATTERN_FILE	*Pattern,
											unsigned short	Mask,
