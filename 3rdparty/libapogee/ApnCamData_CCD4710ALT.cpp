/////////////////////////////////////////////////////////////
//
// ApnCamData_CCD4710ALT.cpp:  Implementation file for the CApnCamData_CCD4710ALT class.
//
...
CApnCamData_CCD4710ALT::CApnCamData_CCD4710ALT()
{
}
...
void CApnCamData_CCD4710ALT::Initialize()
{
	strcpy( m_Sensor, "CCD4710ALT" );
...
void CApnCamData_CCD4710ALT::set_vpattern()
{
	...
	unsigned short Pattern[NumElements] = 
	{
		...
		0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 
		0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 
		0x0002, 0x0002, 0x0002, 0x0002, 0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 
		0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 
		0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 
		0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 0x0006, 
		0x0006, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 
		0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x0004, 0x000C, 0x000C, 
		0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 
		0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 
		0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 
		0x000C, 0x000C, 0x000C, 0x000C, 0x000C, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 
		0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 
		0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 
		0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 
		0x0008, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0001, 0x0000, 
	};
...
void CApnCamData_CCD4710ALT::set_hpattern_skip_sixteen()
{
	const unsigned short Mask = 0x0;
...
void CApnCamData_CCD4710ALT::set_hpattern_clamp_sixteen()
{
	const unsigned short Mask = 0x0;
	const unsigned short BinningLimit = 1;
	const unsigned short RefNumElements = 22;
...
void CApnCamData_CCD4710ALT::set_hpattern_roi_sixteen()
{
	const unsigned short Mask = 0x0;
...
void CApnCamData_CCD4710ALT::set_hpattern_skip_twelve()
{
	const unsigned short Mask = 0x0;
	const unsigned short BinningLimit = 1;
...
void CApnCamData_CCD4710ALT::set_hpattern_clamp_twelve()
{
	const unsigned short Mask = 0x0;
...
void CApnCamData_CCD4710ALT::set_hpattern_roi_twelve()
{
...
void CApnCamData_CCD4710ALT::set_hpattern(	APN_HPATTERN_FILE	*Pattern,
											unsigned short	Mask,
