...
int main(void)
{
    ...
    if(found == 1)
    {
        ...
        if(ret == QHYCCD_SUCCESS)
        {
            printf("Init QHYXXX success!\n");
        }
        else
        {
            printf("Init QHYXXX failue code:%d\n",ret);
            goto failure;
        }
        ...
        if(ret == QHYCCD_SUCCESS)
        {
            printf("Set QHYXXX resolution success!\n");
        }
        else
        {
            printf("Set QHYXXX resolution failure\n");
            goto failure;
        }
