...
int IndiFocusser::init_properties()
{
...
void IndiFocusser::ISGetProperties (const char *dev)
{
    //  First we let our parent populate
    IDLog("IndiFocusser::ISGetProperties %s\n",dev);
    IndiDevice::ISGetProperties(dev);

    return;
}

bool IndiFocusser::UpdateProperties()
{
    if(Connected) {
...
bool IndiFocusser::ISNewNumber (const char *dev, const char *name, double values[], char *names[], int n)
{
    //  first check if it's for our device
    IDLog("IndiFocusser::ISNewNumber %s\n",name);
...
bool IndiFocusser::ISNewSwitch (const char *dev, const char *name, ISState *states, char *names[], int n)
{
...
int IndiFocusser::Move(int,int,int)
{
