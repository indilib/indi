...
**
***************************************************************************************/
FocuserServerClient::FocuserServerClient()
{
...
**
***************************************************************************************/
void FocuserServerClient::newDevice(INDI::BaseDevice * dp)
{
...
**
*************************************************************************************/
void FocuserServerClient::newProperty(INDI::Property * property)
{
...
**
***************************************************************************************/
void FocuserServerClient::setMount(const std::string &value)
{
    mount = value;
...
**
***************************************************************************************/
bool FocuserServerClient::parkMount()
{
...
**
***************************************************************************************/
IPState FocuserServerClient::getMountParkState()
{
...
**
***************************************************************************************/
bool FocuserServerClient::sendEquatorialCoords()
{
...
**
***************************************************************************************/
bool FocuserServerClient::sendGeographicCoords()
{
...
**
***************************************************************************************/
bool FocuserServerClient::sendGotoMode()
{
...
**
***************************************************************************************/
bool FocuserServerClient::abort()
{
    if (abortSP == nullptr)
        return false;
...
***************************************************************************************/
bool FocuserServerClient::setSlewRate(int slewRate)
{
...
**
***************************************************************************************/
bool FocuserServerClient::setMotionNS()
{
...
**
***************************************************************************************/
bool FocuserServerClient::setMotionWE()
{
...
**
***************************************************************************************/
bool FocuserServerClient::setTimeUTC()
{
    if (timeUTC == nullptr)
        return false;
