...
class DSC : public INDI::Telescope, INDI::AlignmentSubsystem::AlignmentSubsystemForDrivers
{
    ...
    private:
        INDI::IEquatorialCoordinates TelescopeEquatorialToSky();
        INDI::IEquatorialCoordinates TelescopeHorizontalToSky();
        ...
        INDI::IHorizontalCoordinates encoderHorizontalCoordinates { 0, 0 };
        INDI::IEquatorialCoordinates encoderEquatorialCoordinates { 0, 0 };
};
