...
class TitanTCS : public INDI::Telescope, public INDI::GuiderInterface
{
  ...
  private:
    ...
    bool CommandResponse(const char* pCommand, const char* pResponse, char delimeter, double *pDouble, int *pInteger=NULL);
    ...
    bool GetParamNumber(const char* pInStr, char* pOutStr, int len, const char* pResponse, char delimeter, double *pDouble, int *pInteger=NULL);
