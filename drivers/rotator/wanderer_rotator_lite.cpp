...
bool WandererRotatorLiteV1::initProperties()
{
...
bool WandererRotatorLiteV1::updateProperties()
{
...
bool WandererRotatorLiteV1::ISNewSwitch(const char *dev, const char *name, ISState *states, char *names[], int n)
{
...
bool WandererRotatorLiteV1::ISNewNumber(const char * dev, const char * name, double values[], char * names[], int n)
{
    if (dev && !strcmp(dev, getDeviceName()))
    {
        // backlash
...
bool WandererRotatorLiteV1::Handshake()
{
    ...
    if(strcmp(name, "WandererRotatorLite")!=0)
    {
        LOG_ERROR("The device is not WandererRotator Lite V1!");
...
IPState WandererRotatorLiteV1::MoveRotator(double angle)
{
    angle = angle - GotoRotatorN[0].value;

    char cmd[16];
    int position = (int)(angle * STEPS_PER_DEGREE+1000000);
...
bool WandererRotatorLiteV1::AbortRotator()
{
...
//////////////////////////////////////////////////////////////////////////////////////////////
/// \brief WandererRotatorLiteV1::HomeRotator
/// \return
///
IPState WandererRotatorLiteV1::HomeRotator()
{
...
bool WandererRotatorLiteV1::ReverseRotator(bool enabled)
{
...
void WandererRotatorLiteV1::TimerHit()
{
...
bool WandererRotatorLiteV1::Move(const char *cmd)
{
    ...
    SetTimer(2000);
    nowtime=0;
    estime=abs((std::atoi(cmd)-1000000)/STEPS_PER_DEGREE*240);
    return true;
}
